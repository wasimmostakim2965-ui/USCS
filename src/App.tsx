    ...
    <main>
      <section className="hero-new">
        <div className="hero-new-copy">
          ...
          <div className="hero-actions"><button className="primary large" onClick={() => { setAuthMode('signup'); setPage('auth'); }}>Create your account <ArrowRight size={17} /></button><button className="hero-signin" onClick={() => { setAuthMode('signin'); setPage(signedIn ? 'dashboard' : 'auth'); }}>Sign in to your account <ArrowRight size={16} /></button></div>
