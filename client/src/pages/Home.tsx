...
function LandingPage() {
  ...
  return <div className="landing-page">
    ...
    <footer className="landing-footer"><span>© 2026 USCS</span><span>Built for people who ship.</span><span><a href="#security">Security</a><a href="#pricing">Pricing</a><button onClick={openAuth}>Sign in</button></span></footer>
